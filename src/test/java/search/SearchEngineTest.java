...
/**
 * Integration tests for the full Search Engine.
 */
class SearchEngineTest {
    ...
    void testBackAndForward() {
        ...
        assertNull(engine.goForward()); // Empty forward stack
    }
    ...
    void testNewViewClearsForwardHistory() {
        ...
        engine.viewDocument("doc3.txt"); // New view should clear forward stack
